...
export const metadata: Metadata = {
  title: 'Help & Support - NutriVKart',
  description: 'Get help with your NutriVKart orders, account, and shopping experience',
}
        ...
        <section className="bg-gradient-to-r from-green-600 to-blue-600 rounded-lg p-12 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="bg-white/10 backdrop-blur rounded-lg p-6 text-center hover:bg-white/20 transition-colors">
              ...
              <a href="mailto:support@nutrivkart.com" className="text-green-100 hover:text-white">
                support@nutrivkart.com
              </a>
            </div>
