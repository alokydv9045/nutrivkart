...
const Form = () => {
  ...
  return (
    <div className="bg-surface text-on-surface antialiased min-h-screen flex flex-col relative overflow-x-hidden">
          ...
          <div className="relative w-full h-full p-12 lg:p-20 flex items-center justify-center">
            ...
            <div className="relative w-full h-full">
              <Image 
                ...
                alt="NutriVKart Premium Supplements"
                fill
                priority
                sizes="50vw"
              />
              ...
              <div className="absolute -bottom-4 -left-4 bg-surface-container-lowest p-6 max-w-xs shadow-xl rounded border border-outline-variant/10 z-20">
                <p className="font-headline italic text-primary text-xl leading-relaxed">
                  Fuel Your Fitness: Premium sports nutrition to push past your limits.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-surface-container-highest text-primary font-body text-[10px] uppercase tracking-[0.2em] font-bold w-full mt-auto flex flex-col md:flex-row justify-between items-center px-12 py-16 gap-8 border-t border-outline-variant/10">
        <div className="flex-shrink-0">
          <span className="font-black uppercase text-lg tracking-widest text-foreground">NutriVKart Store</span>
        </div>
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          <Link className="text-muted-foreground hover:text-foreground transition-colors" href="/about">Sustainability</Link>
          <Link className="text-muted-foreground hover:text-foreground transition-colors" href="/shipping">Shipping</Link>
          <Link className="text-muted-foreground hover:text-foreground transition-colors" href="/privacy">Privacy Policy</Link>
          <Link className="text-muted-foreground hover:text-foreground transition-colors" href="/terms">Terms</Link>
        </div>
        <div className="text-muted-foreground">
          © 2026 NutriVKart. Fuel Your Strength.
        </div>
      </footer>
    </div>
  );
