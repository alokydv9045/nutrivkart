    ...
    <div className="w-full space-y-12">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <h3 className="text-5xl md:text-6xl font-sans tracking-tight text-on-surface font-bold">Sales Overview</h3>
        ...
        <div className="flex gap-4">
          <div className="bg-surface-container-low px-5 py-3 rounded-xl border border-outline-variant/10 flex items-center gap-3 text-xs font-bold text-muted-foreground uppercase tracking-widest shadow-sm">
