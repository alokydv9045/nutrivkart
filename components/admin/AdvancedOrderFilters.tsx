...
export default function AdvancedOrderFilters({
  ...
  return (
    <div className="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10 shadow-sm mb-6">
      ...
      <div className="flex flex-wrap gap-4 mb-4">
        ...
        <div className="flex-1 min-w-64">
          <div className="relative">
            ...
            />
            <svg
              className="w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground/50"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
