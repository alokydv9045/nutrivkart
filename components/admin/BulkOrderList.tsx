    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {orders.map((order) => (
          <div
            key={order._id}
            className={`bg-surface-container-low border border-outline-variant/10 shadow-sm rounded-2xl hover:shadow-lg transition-shadow cursor-pointer ${
                ...
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm mt-4">
                      <div>
                        <span className="text-[10px] uppercase font-bold tracking-widest text-muted-foreground block mb-1">Customer</span>
                      ...
                      <div>
                        <span className="text-[10px] uppercase font-bold tracking-widest text-muted-foreground block mb-1">Items</span>
                        <div className="font-bold text-on-surface">
                      ...
                      <div>
                        <span className="text-[10px] uppercase font-bold tracking-widest text-muted-foreground block mb-1">Total</span>
                      ...
                      <div>
                        <span className="text-[10px] uppercase font-bold tracking-widest text-muted-foreground block mb-1">Date</span>
                        <div className="font-bold text-on-surface">
