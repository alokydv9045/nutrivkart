...
const Text = () => {
  ...
  return (
    <div>
      ...
      <p className='mb-4 font-medium'>
        NutriVKart: Where earth-inspired formulations meet personalized skincare solutions.
      </p>
  ...
  and invitations to private events. Discover NutriVKart’s curated
  ...
  your personal style with NutriVKart and enjoy a shopping experience like no
  other.
      </p>
