...
<head>
  ...
  <style>
    ...
    .header h1 { margin: 0; font-size: 24px; font-style: italic; color: #8CC63F; font-weight: 900; text-transform: uppercase; }
    ...
    .otp-code { font-size: 48px; letter-spacing: 0.15em; color: #1a1a1a; margin: 30px 0; font-family: 'Helvetica', sans-serif; font-weight: 800; }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="message">Please use the following code to complete your login to NutriVKart.</div>
      <div class="otp-code">${otp}</div>
      <div class="expiry">This code will expire in 10 minutes.</div>
    </div>
    <div class="footer">
      © ${new Date().getFullYear()} ${brandName}. Stronger Every Day.
    </div>
  </div>
</body>
</html>
...
<head>
  ...
  <style>
    ...
    .header { padding: 40px; text-align: center; background-color: #141A30; border-bottom: 1px solid #e5e2dd; }
    .header h1 { margin: 0; font-size: 32px; font-weight: 900; letter-spacing: -0.02em; color: #8CC63F; font-family: 'Helvetica', sans-serif; text-transform: uppercase; }
    .content { padding: 60px 40px; text-align: center; }
    .welcome-text { font-size: 14px; text-transform: uppercase; letter-spacing: 0.3em; color: #8CC63F; margin-bottom: 24px; font-weight: 800; }
    .main-title { font-size: 24px; line-height: 1.4; color: #1c1c19; margin-bottom: 32px; font-style: italic; font-weight: 900; text-transform: uppercase; }
    ...
    .otp-code { font-size: 56px; letter-spacing: 0.2em; color: #8CC63F; font-family: 'Helvetica Neue', Arial, sans-serif; font-weight: 800; margin: 0; }
...
<body>
  <div class="container">
    ...
    <div class="content">
      <div class="welcome-text">Fuel Your Strength</div>
      <div class="main-title">You are one step away from joining our community.</div>
...
<head>
  ...
  <style>
    ...
    .header { background: #141A30; border-bottom: 2px solid #8CC63F; color: white; padding: 40px 30px; text-align: center; }
    .header h1 { margin: 0; font-size: 28px; font-weight: 900; text-transform: uppercase; }
    .status-banner { background-color: ${statusColor}; color: white; padding: 20px; text-align: center; font-size: 18px; font-weight: 700; text-transform: uppercase; }
    ...
    .tracking-info { background-color: #f8f3f0; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #8CC63F; }
    .button { display: inline-block; background-color: #8CC63F; color: #0A0E1A; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 700; margin: 20px 0; text-transform: uppercase; }
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="tracking-info">
        <h3 style="margin: 0 0 10px 0; color: #1B2340;">📦 Tracking Information</h3>
